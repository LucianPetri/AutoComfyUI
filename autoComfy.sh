...
SD15_3DANIMATION="https://civitai.com/api/download/models/128046"
...
ANIMATEDIFF_MODELS_FOLDER="models/animatediff_models"
ANIMATEDIFF_LORA_FOLDER="models/animatediff_motion_lora"
...
wget -O $SD15_MODELS_FOLDER/SD15_3D_ANIMATION.safetensors $SD15_3DANIMATION?$TOKEN
...
wget -O $ANIMATEDIFF_LORA_FOLDER/ANIMATEDIFF_ANIMATE_LCM_LORA.safetensors $ANIMATEDIFF_ANIMATE_LCM_LORA?$TOKEN
